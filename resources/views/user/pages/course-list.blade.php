                ...
                <div class="col-md-3">
                    <div class="card border-0 mb-4">
                        ...
                        <div class="card-body py-3 px-0">
                            ...
                            <p class="mb-1 small"><strong>Giảng viên:</strong> {{ $course->user->name }}</p>
                            <p class="mb-1 small"><strong>Đánh giá:</strong> ⭐⭐⭐⭐⭐ (4.8)</p>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body py-0 my-0">
                                        <h5 class="card-title fs-5 fw-bold">{{ $course->name }}</h5>
                                        <p class="card-text small mb-1">{{ Str::limit($course->sort_description, 100) }}
                                        </p>
                                        <p class="mb-1 small"><strong>Giảng viên:</strong> {{ $course->user->name }}</p>
                                        <p class="mb-1 small"><strong>Đánh giá:</strong> ⭐⭐⭐⭐⭐ (4.8)</p>
                                        @if ($course->sale_price)
